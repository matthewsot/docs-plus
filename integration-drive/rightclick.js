$("body").on("mousedown", "#action-dropout .action-context-person", function() {
    $("#action-dropout").hide();

    var attendeeId = $(this).attr("data-id");
    ...
    docs.getSelection(function (currSelectionEl) {
        ...
        action.analytics.increment("right-click-tasks-added");
